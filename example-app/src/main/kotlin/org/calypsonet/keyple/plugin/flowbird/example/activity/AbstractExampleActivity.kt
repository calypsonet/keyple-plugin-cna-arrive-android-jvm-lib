...
import org.calypsonet.keyple.plugin.flowbird.example.adapter.EventAdapter
import org.calypsonet.keyple.plugin.flowbird.example.model.EventModel
import org.calypsonet.keyple.plugin.flowbird.example.util.CalypsoClassicInfo.SAM_PROFILE_NAME
    ...
    override fun setupReader(reader: CardReader) {
      ...
      try {
        SmartCardServiceProvider.getService()
            .getPlugin(reader)
            .getReaderExtension(FlowbirdContactReader::class.java, reader.name)
      } catch (e: Exception) {

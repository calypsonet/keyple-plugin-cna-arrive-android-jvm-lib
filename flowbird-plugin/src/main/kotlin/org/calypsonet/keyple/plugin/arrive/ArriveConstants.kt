...
object ArriveConstants {
  ...
  /**
   * Tag used for logging messages related to the Keyple Arrive Plugin. Typically utilized in
   * conjunction with a logger implementation to differentiate log entries originating from the
   * Arrive plugin.
   *
   * @since 3.0.0
   */
  const val TAG = "KeypleArrivePlugin"
}
